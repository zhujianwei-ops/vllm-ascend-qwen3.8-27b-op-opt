...
| --- | --- | --- | --- |
| Step Communication | 1,709.640 | 1,695.856 | CANN 阶段分类 |
| Step 非重叠通信 | 1,709.492 | 1,695.778 | Stage 分解中的通信部分 |
| 去重 Collective Elapse 累加 | 2,451.225 | 2,437.833 | 逐操作记录，不保证互斥 |
| AllReduce AI_CPU kernel 累加 | 708.092 | 694.713 | 任务包络与等待，不是纯传输 |
| AllReduce SIO transfer 累加 | 1,228.214 | 1,217.983 | 链路工作量 |
